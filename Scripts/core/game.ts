...
File description: This is game.ts file. This file is a main file of this project's applocation. 
Here have all logic for rolling dice */
...
let Game = (function(){
    ...
    let rightReel: Core.GameObject;
     ...
     let leftResuLabel: UIObjects.Label;
     let middleResuLabel:UIObjects.Label;
     let rightResLabel: UIObjects.Label;
